...
[![Latest Stable Version](https://poser.pugx.org/ayangzy/cashier-paystack/v/stable)](https://packagist.org/packages/ayangzy/cashier-paystack)
[![Total Downloads](https://poser.pugx.org/ayangzy/cashier-paystack/downloads)](https://packagist.org/packages/ayangzy/cashier-paystack)
[![License](https://poser.pugx.org/ayangzy/cashier-paystack/license)](https://packagist.org/packages/ayangzy/cashier-paystack)
...
`composer require ayangzy/cashier-paystack`
...
The cards method on the billable model instance returns a collection of `ayangzy\Cashier\Card` instances:
```php
$cards = $user->cards();
```
...
Route::post(
    'paystack/webhook',
    '\ayangzy\Cashier\Http\Controllers\WebhookController@handleWebhook'
);
```
...
use ayangzy\Cashier\Http\Controllers\WebhookController as CashierController;
