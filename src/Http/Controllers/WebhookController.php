...
namespace ayangzy\Cashier\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Support\Carbon;
use Illuminate\Routing\Controller;
use ayangzy\Cashier\Cashier;
use ayangzy\Cashier\Subscription;
use Symfony\Component\HttpFoundation\Response;
use ayangzy\Cashier\Http\Middleware\VerifyWebhookSignature;
...
class WebhookController extends Controller
{
     ...
     *
     * @param  string  $subscriptionCode
     * @return \ayangzy\Cashier\Subscription|null
     */
     ...
     * @return \ayangzy\Cashier\Billable
     */
